    ...
    <div className="w-full min-h-screen text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 pb-24">
        ...
        <p className="text-lg leading-relaxed text-white/80">
          ...
          covering the challenges, your process, the technologies used, and the
          final outcomes. This section can be expanded with more content,
          images, or case study details.
        </p>
      </div>
    </div>
  );
